...
function render(items) {
  ...
  for (const it of items) {
    // Visual observations render as their own paragraph, italic, with NO leading
    // transcript timecode (the "[Scene at H:MM:SS — …]" carries its own reference).
    if (it.kind === 'visual') lines.push(it.body);
